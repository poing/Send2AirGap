...
fmt:              ## Format code using black & isort.
	$(ENV_PREFIX)isort send2airgap/
	$(ENV_PREFIX)black -l 79 send2airgap/
...
test: lint        ## Run tests and generate coverage report.
	$(ENV_PREFIX)pytest -v --cov-config .coveragerc --cov=send2airgap -l --tb=short --maxfail=1 tests/
...
switch-to-poetry: ## Switch to poetry package manager.
	...
	@echo "send2airgap = 'send2airgap.__main__:main'" >> pyproject.toml
	...
	@echo "Please run 'poetry shell' or 'poetry run send2airgap'"
